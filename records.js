...
// Save new employee
if (editIndex !== null) {
records_emp[editIndex] = newEmployee;
editIndex = null;
} else {
records_emp.push(newEmployee);
}
...
function editEmployee(index) {
  ...
  let emp = records_emp[index];  // Correctly reference the selected employee
...
function deleteEmployee(index) {
  let empID = records_emp[index].empID; // Get employee ID
...
function loadEmployees() {
  fetch("fetch_records.php")
      ...
      .then(data => {
          ...
          records_emp = Array.isArray(data) ? data : []; // Ensure it's an array
          renderTable();
      })
