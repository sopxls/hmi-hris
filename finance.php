  ...
  <body>
    ...
    <div id="employeeDetailsModal" class="employee-modal">
        ...
        <div class="table-container">
            <h1 class="dept-title">FINANCE DEPARTMENT</h1>
        ...
        <script src="financeEmpCount.js" defer></script>  
  </body>
</html>
<?php
...
if (isset($_POST['submitBtn'])) {
    ...
    $fullName = "$firstName $middleName $lastName";
        ...
        // Insert new employee
        $query = "INSERT INTO finance_emp (empID, fullName, firstName, middleName, lastName, position, type, startDate, status, sex, 
