...
// Save new employee
if (editIndex !== null) {
  admin_emp[editIndex] = newEmployee;
  editIndex = null;
} else {
  admin_emp.push(newEmployee);
}
...
document.addEventListener("click", function (e) {
  ...
  function editEmployee(index) {
    ...
    let emp = admin_emp[index];  // Correctly reference the selected employee
  ...
  function deleteEmployee(index) {
    let empID = admin_emp[index].empID; // Get employee ID
  ...
  function loadEmployees() {
    fetch("fetch_admin.php")
        ...
        .then(data => {
            ...
            admin_emp = Array.isArray(data) ? data : []; // Ensure it's an array
            renderTable();
        })
