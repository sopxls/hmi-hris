  ...
  <body>
    ...
    <div id="employeeDetailsModal" class="employee-modal">
        ...
        <div class="table-container">
            <h1 class="dept-title">RECORDS DEPARTMENT</h1>
        ...
        <script src="recordsEmpCount.js" defer></script>  
  </body>
</html>
<?php
...
if (isset($_POST['submitBtn'])) {
    ...
    $fullName = "$firstName $middleName $lastName";
        ...
        // Insert new employee
        $query = "INSERT INTO records_emp (empID, fullName, firstName, middleName, lastName, position, type, startDate, status, sex, 
