...
<html lang="en">
  <head>
    ...
    <title>Medical Exam & Evaluation</title>
  ...
  <body>
    ...
    <div id="employeeDetailsModal" class="employee-modal">
        ...
        <div class="table-container">
            <h1 class="dept-title">MEDICAL EXAM & EVALUATION DEPARTMENT</h1>
        ...
        <script src="medicalEmpCount.js" defer></script>  
  </body>
</html>
<?php
...
if (isset($_POST['submitBtn'])) {
    ...
    $fullName = "$firstName $middleName $lastName";
        ...
        // Insert new employee
        $query = "INSERT INTO medical_emp (empID, fullName, firstName, middleName, lastName, position, type, startDate, status, sex, 
