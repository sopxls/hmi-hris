...
// Save new employee
if (editIndex !== null) {
sales_emp[editIndex] = newEmployee;
editIndex = null;
} else {
sales_emp.push(newEmployee);
}
...
function editEmployee(index) {
  ...
  let emp = sales_emp[index];  // Correctly reference the selected employee
...
function deleteEmployee(index) {
  let empID = sales_emp[index].empID; // Get employee ID
...
function loadEmployees() {
  fetch("fetch_sales.php")
      ...
      .then(data => {
          ...
          sales_emp = Array.isArray(data) ? data : []; // Ensure it's an array
          renderTable();
      })
